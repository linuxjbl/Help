...
#a ll='ls -la '
a ll='ls -l --color=auto'
a lla='ls -la --color=auto'
a lld='\ls -la | grep ^d'
a rm='rm -i'
a cp='cp -i'
a so='source ~/.bashrc'
...
a xterm='/usr/bin/xterm -sb -fg white -bg darkslategray -font -misc-fixed-medium-r-semicondensed--13-120-75-75-c-60-iso8859-1'
...
a cdnow='cd /home/jblee/Study/GoLang'
a now=cdnow
